...
public class MainActivity extends AppCompatActivity implements View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et3.setText(prefe.getString("puntaje",""));
    ...
    public void boom() {
        MediaPlayer mp = MediaPlayer.create(this, R.raw.boom);
        mp.start();
    }
    @Override
    ...
    private boolean gano() {
        ...
        et2.setText(String.valueOf(cant));
        int valor = Integer.parseInt(et3.getText().toString());

        if(cant>valor){
            et3.setText(String.valueOf(cant));
            SharedPreferences preferencias=getSharedPreferences("datos", Context.MODE_PRIVATE);
            SharedPreferences.Editor editor=preferencias.edit();
            editor.putString("puntaje",et3.getText().toString());
            editor.commit();
        }
