...
public class MainActivity extends AppCompatActivity {
    ...
    public void controlar(View v){
        ...
        if(numero==num)
        {
            Toast notificacion = Toast.makeText(this,"Muy bien has recordado el numero",Toast.LENGTH_LONG);
            notificacion.show();
        }
        else {
            Toast notificacion = Toast.makeText(this,"Lo siento no es el numero que se ingreso",Toast.LENGTH_LONG);
            notificacion.show();
        }
    }
}